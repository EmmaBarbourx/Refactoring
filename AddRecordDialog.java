...
public class AddRecordDialog extends JDialog implements ActionListener {
	...
	public boolean checkInput() {
	    ...
	    // Validate combo boxes (assuming index 0 is invalid).
	    ...
	    // Validate salary: must be a valid number and non-negative
	    try {
