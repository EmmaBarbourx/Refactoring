...
public class RandomFile {
	...
	public long getFirst() {
        ...
        System.err.println("Error in getFirst(): " + e.getMessage());
        throw new RuntimeException("Error in getFirst()", e);
    }
	...
	public long getLast() {
		...
		try {// try to get position of last record
	        ...
	        System.err.println("Error in getLast(): " + e.getMessage());
	        throw new RuntimeException("Error in getLast()", e);
	    }
	...
	public long getNext(long readFrom) {
		...
		try {// try to read from file
	        ...
	        throw new RuntimeException("Error in getNext()", e);
	    }
		return byteToStart;
	}// end getFirst
	...
	public long getPrevious(long readFrom) {
		...
		try {// try to read from file
	        ...
	        System.err.println("Error in getPrevious(): " + e.getMessage());
	        throw new RuntimeException("Error in getPrevious()", e);
	    }
		return byteToStart;
	}// end getPrevious
	...
	public Employee readRecords(long byteToStart) {
        ...
        System.err.println("Error in readRecords(): " + e.getMessage());
        throw new RuntimeException("Error in readRecords()", e);
    }
	...
	public boolean isPpsExist(String pps, long currentByteStart) {
		...
		try {// try to read from file and look for PPS Number
	        ...
	        System.err.println("Error in isPpsExist(): " + e.getMessage());
	        throw new RuntimeException("Error in isPpsExist()", e);
	    }
	...
	public boolean isSomeoneToDisplay() {
		...
		try {// try to read from file and look for ID
	        ...
	        System.err.println("Error in isSomeoneToDisplay(): " + e.getMessage());
	        throw new RuntimeException("Error in isSomeoneToDisplay()", e);
	    }
